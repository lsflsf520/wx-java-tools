...
import me.chanjar.weixin.mp.bean.menu.json.WxMpMenuGsonAdapter;
...
public class WxMpMenu {
  ...
  static {
    ...
    INSTANCE.registerTypeAdapter(WxMpMenu.class, new WxMpMenuGsonAdapter());
  }

  public static WxMpMenu fromJson(String json) {
    return INSTANCE.create().fromJson(json, WxMpMenu.class);
  }
